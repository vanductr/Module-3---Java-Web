...
public class UserServiceImpl implements IUserService{
    ...
    public List<User> searchUserByCountry(String country) {
        List<User> userList = selectAllUsers();
        List<User> userListSearchByCountry = new ArrayList<>();
        for (User user : userList) {
            if (user.getCountry().equals(country)) {
                userListSearchByCountry.add(user);
            }
        }
        return userListSearchByCountry;
    }
    ...
    @Override
    public void deleteUserStored(int userId) throws SQLException {
    ...
    @Override
    public List<User> showUsersStore() throws SQLException {
        ...
        try (Connection connection = getConnection();
            ...
            // Lặp qua kết quả trả về và thêm người dùng vào danh sách
